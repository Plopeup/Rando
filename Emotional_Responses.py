...
def compliment(happy):
    first_tier = ["sweet","so nice","kind","one of the good ones","flattering","one of the good ones","not annoying"]
...
def sad(pity):
    ...
    second_tier = ["making me shed tears which will result in me short circuiting","a person that enjoys other people's misery","hurting an AI's feeling, which I though was impossible",
